...
Standard keybindings you should know anyway
  ...
  Command + C - Copy
  Command + V - Paste
  Command + Tab - Application selector, I tend to hold command and press left / right and let go to bring it to front. You can tap Q on an app to close it from here.
  Command + T - New Tab
  ...
  When in a standard text input box
    ...
    You can hold shift for the above ones to select the jumped region
