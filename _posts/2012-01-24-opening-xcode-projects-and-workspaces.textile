...
In honour of cocoapods, which I've been experimenting with lately I figured it was time to update an old bash script I was using multiple times daily. It started off extremely simple as an alias.
